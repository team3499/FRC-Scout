<div id="showDataPage" class="viewPage">
    ...
    <div id="viewTeamWrap">
        ...
        <table id="tableTeams">
            <tr>
                <td class="tableTeamsTeam"><strong>Team</strong></td>
                <td class="tableTeamsCatch"><strong>Catch?</strong></td>
                <td class="tableTeamsPickup"><strong>Pickup?</strong></td>
                <td class="tableTeamsThrow"><strong>Throw?</strong></td>
                <td class="tableTeamsAuto"><strong>Auto?</strong></td>
                <td class="tableTeamsNotes"><strong>Notes</strong></td>
    ...
    <div id="viewMatchWrap">
        ...
        <table id="tableMatches">
            <tr>
               ...
               <td class="tableMatchesNotes"><strong>Match Notes</strong></td>
               <td class="tableMatchesWin"><strong>Team Winner</strong></td>
            </tr>
            <tr>
